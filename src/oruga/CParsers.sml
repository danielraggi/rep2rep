...
struct
  ...
  fun parseProbSys s =
      let val dContent = Document.read "bTreeBayes"
          ...
          val result0 = (Seq.hd (Transfer.structureTransfer (SOME 3, NONE, SOME 100) false NONE state0))
          ...
          val result1 = (Seq.hd (Transfer.structureTransfer (SOME 3, NONE, SOME 100) false NONE state1))
          ...
          val result2 = (Seq.hd (Transfer.structureTransfer (SOME 3, NONE, SOME 100) false NONE state2))
          ...
          val result3 = (Seq.hd (Transfer.structureTransfer (SOME 3, NONE, SOME 100) false NONE state3))
          ...
          val result4 = (Seq.hd (Transfer.structureTransfer (SOME 3, NONE, SOME 100) false NONE state4))
          ...
          val result5 = (Seq.hd (Transfer.structureTransfer (SOME 3, NONE, SOME 100) false NONE state5))
          ...
          val result6 = (Seq.hd (Transfer.structureTransfer (SOME 3, NONE, SOME 100) false NONE state6))
          ...
          val result7 = (Seq.hd (Transfer.structureTransfer (SOME 3, NONE, SOME 100) false NONE state7))
          ...
          val result8 = (Seq.hd (Transfer.structureTransfer (SOME 6, NONE , SOME 500) false NONE state8))
